const episodeData = {
  ...
  topics: [
    {
      topicId: 1,
      topic: "❓ Learn to use How and Why (Come & Perché)",
    ...
    {
      topicId: 2,
      topic: "❓ Learn to use What and Which (Cosa & Quale)",
      ...
      scenes: [
        ...
        },
        {
          ...
          dialogue: [
            ...
            { "speaker": "Male", "text": "Cosa fai nel weekend?", "en": "What do you do on weekends?", "zh": "你週末做什麼？" },
            { "speaker": "Female", "text": "Esco con gli amici.", "en": "I go out with friends.", "zh": "我會和朋友出去。" },
        ...
        },
        {
          ...
          dialogue: [
            { "speaker": "Male", "text": "Buongiorno! Cosa vuoi da bere?", "en": "Good morning! What do you want to drink?", "zh": "早安！你想喝什麼？" },
            { speaker: "Female", text: "Vorrei un cappuccino.", en: "I’d like a cappuccino.", zh: "我想要一杯卡布奇諾。" },
            { speaker: "Male", text: "Perfetto. E tu, cosa vuoi?", en: "Perfect. And you, what do you want?", zh: "太好了。那你呢？你要什麼？" },
            { speaker: "Female2", text: "Io prendo un tè al limone.", en: "I’ll have a lemon tea.", zh: "我要一杯檸檬茶。" },
            { speaker: "Male", text: "Ottimo. E da mangiare, cosa volete?", en: "Great. And to eat, what do you want?", zh: "很好。那要吃的呢？你們要什麼？" },
            { speaker: "Female", text: "Io voglio un cornetto alla crema.", en: "I want a cream croissant.", zh: "我要一個奶油可頌。" },
            { speaker: "Female2", text: "E io voglio una fetta di torta.", en: "And I want a slice of cake.", zh: "我要一片蛋糕。" },
            { speaker: "Male", text: "Perfetto. Quale torta preferisci?", en: "Perfect. Which cake do you prefer?", zh: "太好了。你比較喜歡哪一個蛋糕？" },
            { speaker: "Female2", text: "La torta al cioccolato, per favore.", en: "The chocolate cake, please.", zh: "我要巧克力蛋糕，謝謝。" },
            { speaker: "Female", text: "Che buono! Anch’io la voglio domani.", en: "So good! I want it too tomorrow.", zh: "真好吃！我明天也要點這個。" },
            { speaker: "Male", text: "Va bene. Arriva subito.", en: "Alright. It’s coming right up.", zh: "好的，馬上來。" },
            { speaker: "Female2", text: "Grazie mille!", en: "Thanks a lot!", zh: "非常感謝！" }
          ]
        },
        {
          sceneId: 5,
          ...
          dialogue: [
            { "speaker": "Female", "text": "Che cos’è sul tavolo?", "en": "What is on the table?", "zh": "桌上的是什麼？" },
            { "speaker": "Male", "text": "È un dizionario.", "en": "It’s a dictionary.", "zh": "這是一本字典。" },
        ...
        // Day 6 – Choosing desserts & drinks (Qual è / Quale)
        {
          ...
          dialogue: [
            { "speaker": "Female", "text": "Qual è il tuo piatto preferito?", "en": "What’s your favorite dish?", "zh": "你最喜歡的菜是什麼？" },
            { speaker: "Male", text: "La pasta alla carbonara.", en: "Pasta carbonara.", zh: "卡邦那拉義大利麵。" },
            { speaker: "Female", text: "qual è il tuo dolce preferito?", en: "which is your favorite dessert?", zh: "那你最喜歡的甜點是哪一個？" },
        ...
        // Day 8 – Favorites & choices (Qual è / Quale)
        {
          ...
          dialogue: [
            { speaker: "Female", text: "Qual è il tuo colore preferito?", en: "What’s your favorite color?", zh: "你最喜歡的顏色是什麼？" },
            { speaker: "Male", text: "Il blu.", en: "Blue.", zh: "藍色。" },
            { speaker: "Female", text: "Qual è il tuo sport preferito?", en: "What’s your favorite sport?", zh: "你最喜歡的運動是什麼？" },
            { speaker: "Male", text: "Il calcio.", en: "Soccer.", zh: "足球。" },
            { speaker: "Female", text: "Qual è la tua stagione preferita?", en: "What’s your favorite season?", zh: "你最喜歡的季節是什麼？" },
            { speaker: "Male", text: "L’estate.", en: "Summer.", zh: "夏天。" },
            { speaker: "Female", text: "Qual è il tuo film preferito?", en: "What’s your favorite movie?", zh: "你最喜歡的電影是什麼？" },
            { speaker: "Male", text: "Un film di azione.", en: "An action movie.", zh: "一部動作片。" },
            { speaker: "Female", text: "Qual è l’orario migliore?", en: "What’s the best time?", zh: "最好的時間是什麼？" },
            { speaker: "Male", text: "Alle otto e mezza.", en: "At eight-thirty.", zh: "八點半。" },
            { speaker: "Female", text: "Perfetto, prenoto i biglietti.", en: "Perfect, I’ll book the tickets.", zh: "太好了，我來訂票。" },
            { speaker: "Male", text: "Grazie!", en: "Thanks!", zh: "謝謝！" }
          ]
        },
        ...
        // Day 10 – Review: Which…? + quick small talk
        {
          ...
          dialogue: [
            ...
            { speaker: "Male", text: "la margherita.", en: "margherita.", zh: "通常是瑪格麗塔。" },
    ...
    {
      topicId: 3,
      topic: "❓Learn to use How much, How many and where (Quanto & Quanti)",
      ...
      scenes: [
        // Day 1（上面已給）——在餐廳
        {
          ...
          dialogue: [
            { speaker: "Female", text: "Buonasera! Possiamo cenare qui?", en: "Good evening! Can we have dinner here?", zh: "晚上好！我們可以在這裡吃晚餐嗎？" },
            { speaker: "Male", text: "Certo! Quante persone siete?", en: "Of course! How many people are you?", zh: "當然！你們有幾位？" },
            { speaker: "Female", text: "Siamo in tre.", en: "We are three.", zh: "我們有三位。" },
            { speaker: "Male", text: "Perfetto, vi accompagno al tavolo.", en: "Perfect, I’ll take you to the table.", zh: "太好了，我帶你們去座位。" },
            { speaker: "Female", text: "Grazie! Quanto costa il menù fisso?", en: "Thanks! How much is the fixed menu?", zh: "謝謝！套餐多少錢？" },
            { speaker: "Male", text: "Costa venti euro a persona.", en: "It costs twenty euros per person.", zh: "每人二十歐元。" },
            { speaker: "Female", text: "E quante portate include?", en: "And how many courses does it include?", zh: "有幾道菜？" },
            { speaker: "Male", text: "Tre portate: antipasto, primo e dolce.", en: "Three courses: appetizer, main, and dessert.", zh: "三道菜：前菜、主菜和甜點。" },
            { speaker: "Female", text: "Ottimo! Quanto costa una bottiglia di vino?", en: "Great! How much is a bottle of wine?", zh: "太好了！一瓶酒多少錢？" },
            { speaker: "Male", text: "Quindici euro.", en: "Fifteen euros.", zh: "十五歐元。" },
            { speaker: "Female", text: "Perfetto, prendiamo tre menù fissi e una bottiglia di vino.", en: "Perfect, we’ll take three fixed menus and a bottle of wine.", zh: "太好了，那我們要三份套餐和一瓶酒。" },
            { speaker: "Male", text: "Va bene, arrivo subito.", en: "Alright, I’ll be right back.", zh: "好的，我馬上來。" }
          ]
        },
        // Day 2——在火車站（你要的括號提示）
        {
          ...
          scene_zh: "第 2 天 – 在火車站",
          dialogue: [
            { speaker: "Female", text: "Buongiorno! Vorrei un biglietto per Firenze.", en: "Good morning! I’d like a ticket to Florence.", zh: "早安！我要一張去佛羅倫斯的票。" },
            { speaker: "Male", text: "Quando vuole partire?", en: "When do you want to leave?", zh: "您想什麼時候出發？" },
            { speaker: "Female", text: "Oggi pomeriggio.", en: "This afternoon.", zh: "今天下午。" },
            { speaker: "Male", text: "Perfetto. Quale treno preferisce, l’alta velocità o il regionale?", en: "Perfect. Which train do you prefer, the high-speed or the regional?", zh: "好的。您要哪一班火車，高速還是區間？" },
            { speaker: "Female", text: "Preferisco l’alta velocità.", en: "I prefer the high-speed train.", zh: "我想要高速火車。" },
            { speaker: "Female", text: "Quanto costa il biglietto?", en: "How much is the ticket?", zh: "票多少錢？" },
        ...
        // Day 5——博物館買票（綜合：幾個人、多少錢、多久）
        {
          ...
          dialogue: [
            { speaker: "Female", text: "Buongiorno! Quanti biglietti per favore.", en: "Good morning! (We need) how many tickets please?", zh: "早安！我們要買幾張票，麻煩了。" },
            { speaker: "Male", text: "Quanti siete?", en: "How many of you are there?", zh: "你們幾位？" },
            { speaker: "Female", text: "Siamo in due adulti e un bambino.", en: "Two adults and one child.", zh: "兩大一小。" },
            { speaker: "Male", text: "Va bene. Il bambino quanti anni ha?", en: "Alright. How old is the child?", zh: "好的。小孩幾歲？" },
            { speaker: "Female", text: "Ha otto anni.", en: "He is eight years old.", zh: "他八歲。" },
            { speaker: "Male", text: "Perfetto: adulti dodici euro, bambino sei euro.", en: "Perfect: adults twelve euros, child six euros.", zh: "好的：大人十二歐，小孩六歐。" },
            { speaker: "Female", text: "Grazie. Quanto dura la visita media?", en: "Thanks. How long does an average visit take?", zh: "謝謝。一般參觀需要多久？" },
            { speaker: "Male", text: "Circa un’ora e mezza.", en: "About an hour and a half.", zh: "大約一個半小時。" },
            { speaker: "Female", text: "Benissimo. Quanto costa l’audioguida?", en: "Great. How much is the audio guide?", zh: "太好了。語音導覽多少錢？" },
            { speaker: "Male", text: "Quattro euro a persona.", en: "Four euros per person.", zh: "每人四歐。" },
            { speaker: "Female", text: "Allora prendiamo tre biglietti e due audioguide.", en: "Then we’ll take three tickets and two audio guides.", zh: "那我們要三張票、兩個語音導覽。" },
            { speaker: "Male", text: "Perfetto, buon divertimento!", en: "Perfect, enjoy!", zh: "太好了，玩得愉快！" }
          ]
        },
        {
          sceneId: 6,
          ...
          scene_zh: "第 6 天 – …在哪裡？",
          dialogue: [
            { speaker: "Female", text: "Scusi, dov’è il bagno?", en: "Excuse me, where is the bathroom?", zh: "不好意思，洗手間在哪裡？" },
            { speaker: "Male", text: "È a destra.", en: "It’s on the right.", zh: "在右邊。" },
            { speaker: "Female", text: "Grazie mille! E dove si trova la cassa?", en: "Thanks a lot! And where is the cashier?", zh: "非常感謝！那收銀台在哪裡？" },
            { speaker: "Male", text: "Accanto all’entrata.", en: "Next to the entrance.", zh: "在入口旁邊。" },
            { speaker: "Female", text: "Perfetto. Dove posso prendere un taxi?", en: "Perfect. Where can I get a taxi?", zh: "太好了。我在哪裡可以搭計程車？" },
            { speaker: "Male", text: "Fuori, davanti all’hotel.", en: "Outside, in front of the hotel.", zh: "在外面，飯店前面。" },
            { speaker: "Female", text: "Ottimo, grazie ancora!", en: "Great, thanks again!", zh: "太棒了，再次感謝！" },
            { speaker: "Male", text: "Prego, buona giornata!", en: "You’re welcome, have a nice day!", zh: "不客氣，祝你今天愉快！" }
          ]
        },
        {
          sceneId: 7,
          scene: "Day 7 – At the station (asking locations)",
          scene_zh: "第 7 天 – 在車站問路",
          dialogue: [
            { speaker: "Female", text: "Scusi, dov’è la biglietteria?", en: "Excuse me, where is the ticket office?", zh: "不好意思，售票處在哪裡？" },
            { speaker: "Male", text: "È lì, accanto alla farmacia.", en: "It’s there, next to the pharmacy.", zh: "就在那裡，藥局旁邊。" },
            { speaker: "Female", text: "Grazie! E dov’è la sala d’attesa?", en: "Thanks! And where is the waiting room?", zh: "謝謝！那候車室在哪裡？" },
            { speaker: "Male", text: "Al primo piano.", en: "On the first floor.", zh: "在一樓。" },
            { speaker: "Female", text: "Perfetto. Dove si trovano i bagni?", en: "Perfect. Where are the bathrooms?", zh: "太好了。洗手間在哪裡？" },
            { speaker: "Male", text: "In fondo al corridoio, a sinistra.", en: "At the end of the corridor, on the left.", zh: "在走廊盡頭，左邊。" },
            { speaker: "Female", text: "Ottimo, grazie mille!", en: "Great, thanks a lot!", zh: "太棒了，非常感謝！" },
            { speaker: "Male", text: "Prego, buona giornata!", en: "You’re welcome, have a good day!", zh: "不客氣，祝您有美好的一天！" }
          ]
        },
        {
          sceneId: 8,
          ...
          dialogue: [
            { speaker: "Female", text: "Ciao! Di dove sei?", en: "Hi! Where are you from?", zh: "嗨！你從哪裡來？" },
            { speaker: "Male", text: "Sono di Firenze. E tu?", en: "I’m from Florence. And you?", zh: "我來自佛羅倫斯。你呢？" },
            { speaker: "Female", text: "Io sono di Napoli.", en: "I’m from Naples.", zh: "我來自拿坡里。" },
            { speaker: "Male", text: "Interessante! E di dove è la tua famiglia?", en: "Interesting! And where is your family from?", zh: "有意思！那你的家人來自哪裡？" },
            { speaker: "Female", text: "La mia famiglia è di Sicilia.", en: "My family is from Sicily.", zh: "我家人來自西西里。" },
            { speaker: "Male", text: "Wow! E adesso vivi a Roma?", en: "Wow! And now do you live in Rome?", zh: "哇！那你現在住在羅馬嗎？" },
            { speaker: "Female", text: "Sì, da tre anni.", en: "Yes, for three years.", zh: "是的，三年了。" },
            { speaker: "Male", text: "E dove studi o lavori?", en: "And where do you study or work?", zh: "那你在哪裡讀書或工作？" },
            { speaker: "Female", text: "Lavoro in un ufficio in centro.", en: "I work in an office downtown.", zh: "我在市中心的一間辦公室上班。" },
            { speaker: "Male", text: "Perfetto. Piace anche a te vivere qui?", en: "Perfect. Do you also like living here?", zh: "太好了。你也喜歡住在這裡嗎？" },
            { speaker: "Female", text: "Sì, molto! Roma è bellissima.", en: "Yes, a lot! Rome is beautiful.", zh: "非常喜歡！羅馬很美。" },
            { speaker: "Male", text: "Anch’io la adoro.", en: "I love it too.", zh: "我也很喜歡。" }
          ]
        },
        {
          sceneId: 9,
        ...
        },
        {
          ...
          dialogue: [
            { speaker: "Female", text: "Ciao! Dove vai?", en: "Hi! Where are you going?", zh: "嗨！你要去哪裡？" },
            { speaker: "Male", text: "Vado al mercato.", en: "I’m going to the market.", zh: "我要去市場。" },
            { speaker: "Female", text: "Anch’io! Dov’è?", en: "Me too! Where is it?", zh: "我也是！在哪裡？" },
            { speaker: "Male", text: "Vicino alla piazza principale.", en: "Near the main square.", zh: "在主要廣場附近。" },
            { speaker: "Female", text: "Perfetto. E dopo dove vai?", en: "Perfect. And after that, where are you going?", zh: "太好了。那之後你要去哪裡？" },
            { speaker: "Male", text: "A casa, per cucinare.", en: "Home, to cook.", zh: "回家做飯。" },
            { speaker: "Female", text: "Che buono! Dove compri di solito la frutta?", en: "Yum! Where do you usually buy fruit?", zh: "真好吃！你通常在哪裡買水果？" },
            { speaker: "Male", text: "Sempre al mercato locale.", en: "Always at the local market.", zh: "總是在當地市場。" },
            { speaker: "Female", text: "Fantastico. Allora andiamo insieme.", en: "Fantastic. Then let’s go together.", zh: "太棒了。那我們一起去吧。" },
            { speaker: "Male", text: "Volentieri!", en: "Gladly!", zh: "好啊！" }
          ]
        }
      ]
    },
    {
      ...
      scenes: [
        ...
        },
        {
          ...
          dialogue: [
            { speaker: "Male", text: "Buongiorno! Cosa prende oggi?", en: "Good morning! What would you like today?", zh: "早安！您今天要喝什麼？" },
            { speaker: "Female", text: "Vorrei un cappuccino, grazie. E lei?", en: "I’d like a cappuccino, thanks. And you?", zh: "我要一杯卡布奇諾，謝謝。您呢？" },
            { speaker: "Male", text: "Io prendo un tè verde.", en: "I’ll have a green tea.", zh: "我要一杯綠茶。" },
            { speaker: "Female", text: "Perché non prende il caffè oggi?", en: "Why aren’t you having coffee today?", zh: "您今天怎麼不喝咖啡？" },
            { speaker: "Male", text: "Perché sono un po’ stanco.", en: "Because I’m a bit tired.", zh: "因為我有點累。" },
            { speaker: "Female", text: "Capisco. Quanto costa il cappuccino qui?", en: "I see. How much does the cappuccino cost here?", zh: "我懂。這裡的卡布奇諾多少錢？" },
            { speaker: "Male", text: "Costa due euro e cinquanta.", en: "It costs two euros and fifty.", zh: "要兩歐五。" },
            { speaker: "Female", text: "Non è caro. Quale bar preferisce di solito?", en: "That’s not expensive. Which café do you usually prefer?", zh: "不貴啊。您平常喜歡哪一家咖啡館？" },
            { speaker: "Male", text: "Mi piace questo bar perché è tranquillo.", en: "I like this café because it’s quiet.", zh: "我喜歡這家，因為很安靜。" },
            { speaker: "Female", text: "Ottimo. Allora ci vediamo qui domani?", en: "Great. So shall we meet here tomorrow?", zh: "太好了。那我們明天在這裡見？" },
            { speaker: "Male", text: "Sì, domani mattina alle dieci.", en: "Yes, tomorrow morning at ten.", zh: "對，明天早上十點。" },
            { speaker: "Female", text: "Perfetto, a domani!", en: "Perfect, see you tomorrow!", zh: "太好了，明天見！" }
          ]
        },
        {
          sceneId: 3,
          ...
          dialogue: [
            { speaker: "Female", text: "Buongiorno! Vorrei andare a Firenze. Quando parte il treno?", en: "Good morning! I’d like to go to Florence. When does the train leave?", zh: "早安！我想去佛羅倫斯。火車什麼時候出發？" },
            { speaker: "Male", text: "Domani mattina presto.", en: "Tomorrow morning early.", zh: "明天一大早。" },
            { speaker: "Female", text: "Quale treno devo prendere?", en: "Which train should I take?", zh: "我應該搭哪一班火車？" },
            { speaker: "Male", text: "Il treno delle otto e mezza.", en: "The eight-thirty train.", zh: "八點半的火車。" },
            { speaker: "Female", text: "E posso sedermi vicino al finestrino?", en: "And can I sit by the window?", zh: "我可以坐靠窗嗎？" },
            { speaker: "Male", text: "Sì, il finestrino è più comodo.", en: "Yes, the window seat is more comfortable.", zh: "對，靠窗比較舒服。" },
            { speaker: "Female", text: "Quanto dura il viaggio?", en: "How long is the trip?", zh: "旅程多久？" },
            { speaker: "Male", text: "Circa un’ora e mezza.", en: "About an hour and a half.", zh: "大概一個半小時。" },
            { speaker: "Female", text: "E perché vado a Firenze?", en: "And why am I going to Florence?", zh: "那我為什麼要去佛羅倫斯？" },
            { speaker: "Male", text: "Per visitare un’amica.", en: "To visit a friend.", zh: "去看一個朋友。" },
            { speaker: "Female", text: "Che bello! Grazie, buon consiglio.", en: "That’s nice! Thanks, good advice.", zh: "真好！謝謝，建議很好。" },
            { speaker: "Male", text: "Prego, buon viaggio!", en: "You’re welcome, have a good trip!", zh: "不客氣，旅途愉快！" }
          ]
        },
        {
          sceneId: 4,
        ...
        },
        {
          ...
          scene_zh: "第 6 天 – 在課堂上",
          dialogue: [
            { speaker: "Female", text: "Professoressa, come si dice 'apple' in italiano?", en: "Teacher, how do you say 'apple' in Italian?", zh: "老師，apple 用義大利語怎麼說？" },
            { speaker: "Male", text: "Si dice 'mela'.", en: "You say 'mela'.", zh: "說 'mela'。" },
            { speaker: "Female", text: "E cosa significa 'grazie'?", en: "And what does 'grazie' mean?", zh: "那 'grazie' 是什麼意思？" },
            { speaker: "Male", text: "Significa 'thank you'.", en: "It means 'thank you'.", zh: "意思是『謝謝』。" },
            { speaker: "Female", text: "Perché studiamo i colori oggi?", en: "Why are we studying colors today?", zh: "為什麼我們今天學顏色？" },
            { speaker: "Male", text: "Perché sono molto usati.", en: "Because they are used a lot.", zh: "因為它們很常用。" },
            { speaker: "Female", text: "Quanto tempo dura la lezione?", en: "How long is the lesson?", zh: "課程多久？" },
            { speaker: "Male", text: "Un’ora.", en: "One hour.", zh: "一小時。" }
          ]
        },
        {
          sceneId: 7,
          ...
          dialogue: [
            { speaker: "Female", text: "Buongiorno! Vorrei un biglietto per Napoli.", en: "Good morning! I’d like a ticket to Naples.", zh: "早安！我要一張去拿坡里的票。" },
            { speaker: "Male", text: "Quando vuole partire?", en: "When do you want to leave?", zh: "您想什麼時候出發？" },
            { speaker: "Female", text: "Oggi pomeriggio.", en: "This afternoon.", zh: "今天下午。" },
            { speaker: "Male", text: "Perfetto. Quale treno preferisce?", en: "Perfect. Which train do you prefer?", zh: "好的。您要哪一班火車？" },
            { speaker: "Female", text: "Quello delle due e mezza.", en: "The two-thirty one.", zh: "兩點半那班。" },
            { speaker: "Male", text: "Quanto costa.", en: "How much is it?", zh: "多少錢？" },
            { speaker: "Female", text: "Quaranta euro.", en: "Forty euros.", zh: "四十歐元。" },
            { speaker: "Male", text: "Perfetto, allora ecco il biglietto.", en: "Perfect, here’s your ticket.", zh: "太好了，這是您的票。" },
            { speaker: "Female", text: "Grazie mille!", en: "Thanks a lot!", zh: "非常感謝！" },
            { speaker: "Male", text: "Prego, buon viaggio!", en: "You’re welcome, have a good trip!", zh: "不客氣，祝您旅途愉快！" }
          ]
        },
        {
          sceneId: 8,
